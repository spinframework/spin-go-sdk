...
import (
	"github.com/spinframework/spin-go-sdk/v3/exports/spin_up_redis_trigger_4_0_0/export_spin_redis_inbound_redis"
	"github.com/spinframework/spin-go-sdk/v3/imports/spin_redis_redis"
...
func wasm_export_spin_redis_inbound_redis_handle_message(arg0 uintptr, arg1 uint32) int32 {
	return int32(witAsync.Run(func() {
		pinner := &runtime.Pinner{}
		value := unsafe.Slice((*uint8)(unsafe.Pointer(arg0)), arg1)
		witRuntime.Unpin()
		result := export_spin_redis_inbound_redis.HandleMessage(value)
		var option int32
		var option2 int32
		var option3 uintptr
		var option4 uint32
		...
		case witTypes.ResultErr:
			...
			var variant1 uint32
			switch payload.Tag() {
			case spin_redis_redis.ErrorInvalidAddress:

				variant = int32(0)
				variant0 = 0
				variant1 = 0

			case spin_redis_redis.ErrorTooManyConnections:

				variant = int32(1)
				variant0 = 0
				variant1 = 0

			case spin_redis_redis.ErrorTypeError:

				variant = int32(2)
				variant0 = 0
				variant1 = 0

			case spin_redis_redis.ErrorOther:
		...
		wasm_export_task_return_spin_redis_inbound_redis_handle_message(option, option2, option3, option4)

	}))
}

//go:wasmexport [callback][async-lift]spin:redis/inbound-redis@3.0.0#handle-message
func wasm_export_callback_spin_redis_inbound_redis_handle_message(event0 uint32, event1 uint32, event2 uint32) uint32 {
...
func wasm_export_task_return_spin_redis_inbound_redis_handle_message(arg0 int32, arg1 int32, arg2 uintptr, arg3 uint32)
