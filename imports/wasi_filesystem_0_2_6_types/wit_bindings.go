...
package wasi_filesystem_0_2_6_types

import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_clocks_0_2_6_wall_clock"
...
type Error = wasi_io_0_2_6_error.Error
type Datetime = wasi_clocks_0_2_6_wall_clock.Datetime
...
type DescriptorStat struct {
	...
	DataAccessTimestamp witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
	// Last data modification timestamp.
	//
	// If the `option` is none, the platform doesn't maintain a
	// modification timestamp for this file.
	DataModificationTimestamp witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
	// Last file status-change timestamp.
	//
	// If the `option` is none, the platform doesn't maintain a
	// status-change timestamp for this file.
	StatusChangeTimestamp witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
}
...
func (self NewTimestamp) Timestamp() wasi_clocks_0_2_6_wall_clock.Datetime {
	if self.tag != NewTimestampTimestamp {
		panic("tag mismatch")
	}
	return self.value.(wasi_clocks_0_2_6_wall_clock.Datetime)
}
...
func MakeNewTimestampTimestamp(value wasi_clocks_0_2_6_wall_clock.Datetime) NewTimestamp {
...
func (self *Descriptor) ReadViaStream(offset uint64) witTypes.Result[*wasi_io_0_2_6_streams.InputStream, ErrorCode] {
	...
	var result witTypes.Result[*wasi_io_0_2_6_streams.InputStream, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_io_0_2_6_streams.InputStream, ErrorCode](wasi_io_0_2_6_streams.InputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = witTypes.Err[*wasi_io_0_2_6_streams.InputStream, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) WriteViaStream(offset uint64) witTypes.Result[*wasi_io_0_2_6_streams.OutputStream, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_method_descriptor_write_via_stream((self).Handle(), int64(offset), returnArea)
	var result witTypes.Result[*wasi_io_0_2_6_streams.OutputStream, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_io_0_2_6_streams.OutputStream, ErrorCode](wasi_io_0_2_6_streams.OutputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = witTypes.Err[*wasi_io_0_2_6_streams.OutputStream, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) AppendViaStream() witTypes.Result[*wasi_io_0_2_6_streams.OutputStream, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) Stat() witTypes.Result[DescriptorStat, ErrorCode] {
	...
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		var option witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 32))) {
		case 0:

			option = witTypes.None[wasi_clocks_0_2_6_wall_clock.Datetime]()
		case 1:

			option = witTypes.Some[wasi_clocks_0_2_6_wall_clock.Datetime](wasi_clocks_0_2_6_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 40))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 48)))})
		default:
			panic("unreachable")
		}
		var option0 witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 56))) {
		case 0:

			option0 = witTypes.None[wasi_clocks_0_2_6_wall_clock.Datetime]()
		case 1:

			option0 = witTypes.Some[wasi_clocks_0_2_6_wall_clock.Datetime](wasi_clocks_0_2_6_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 64))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 72)))})
		default:
			panic("unreachable")
		}
		var option1 witTypes.Option[wasi_clocks_0_2_6_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 80))) {
		case 0:

			option1 = witTypes.None[wasi_clocks_0_2_6_wall_clock.Datetime]()
		case 1:

			option1 = witTypes.Some[wasi_clocks_0_2_6_wall_clock.Datetime](wasi_clocks_0_2_6_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 88))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 96)))})
		default:
			panic("unreachable")
		}
...
func FilesystemErrorCode(err *wasi_io_0_2_6_error.Error) witTypes.Option[ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
