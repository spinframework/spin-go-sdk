...
func (self StreamError) LastOperationFailed() *wasi_io_0_2_6_error.Error {
	if self.tag != StreamErrorLastOperationFailed {
		panic("tag mismatch")
	}
	return self.value.(*wasi_io_0_2_6_error.Error)
}

func MakeStreamErrorLastOperationFailed(value *wasi_io_0_2_6_error.Error) StreamError {
...
func (self *InputStream) Read(len uint64) witTypes.Result[[]uint8, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_6_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), (4 + 1*4)))))))
...
func (self *InputStream) Skip(len uint64) witTypes.Result[uint64, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_6_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 12))))))
...
func (self *InputStream) Subscribe() *wasi_io_0_2_6_poll.Pollable {
...
func (self *OutputStream) Write(contents []uint8) witTypes.Result[witTypes.Unit, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_6_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8))))))
...
func (self *OutputStream) Subscribe() *wasi_io_0_2_6_poll.Pollable {
