...
package wasi_keyvalue_0_2_0_draft2_batch
...
func GetMany(bucket *wasi_keyvalue_0_2_0_draft2_store.Bucket, keys []string) witTypes.Result[[]witTypes.Tuple2[string, witTypes.Option[[]uint8]], wasi_keyvalue_0_2_0_draft2_store.Error] {
	...
	var result3 witTypes.Result[[]witTypes.Tuple2[string, witTypes.Option[[]uint8]], wasi_keyvalue_0_2_0_draft2_store.Error]
	...
	case 0:
		...
		result3 = witTypes.Ok[[]witTypes.Tuple2[string, witTypes.Option[[]uint8]], wasi_keyvalue_0_2_0_draft2_store.Error](result1)
	case 1:
		...
		case 2:
			...
			variant = wasi_keyvalue_0_2_0_draft2_store.MakeErrorOther(value2)

		default:
			panic("unreachable")
		}

		result3 = witTypes.Err[[]witTypes.Tuple2[string, witTypes.Option[[]uint8]], wasi_keyvalue_0_2_0_draft2_store.Error](variant)
	default:
		panic("unreachable")
	}
	result4 := result3
...
func SetMany(bucket *wasi_keyvalue_0_2_0_draft2_store.Bucket, keyValues []witTypes.Tuple2[string, []uint8]) witTypes.Result[witTypes.Unit, wasi_keyvalue_0_2_0_draft2_store.Error] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result0 witTypes.Result[witTypes.Unit, wasi_keyvalue_0_2_0_draft2_store.Error]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result0 = witTypes.Ok[witTypes.Unit, wasi_keyvalue_0_2_0_draft2_store.Error](witTypes.Unit{})
	case 1:
		var variant wasi_keyvalue_0_2_0_draft2_store.Error
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4))) {
		case 0:
		...
		result0 = witTypes.Err[witTypes.Unit, wasi_keyvalue_0_2_0_draft2_store.Error](variant)
	default:
		panic("unreachable")
	}
	result1 := result0
...
func DeleteMany(bucket *wasi_keyvalue_0_2_0_draft2_store.Bucket, keys []string) witTypes.Result[witTypes.Unit, wasi_keyvalue_0_2_0_draft2_store.Error] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
