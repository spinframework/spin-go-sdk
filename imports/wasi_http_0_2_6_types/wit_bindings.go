...
package wasi_http_0_2_6_types

import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_io_0_2_6_error"
...
type IoError = wasi_io_0_2_6_error.Error
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]fields
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]incoming-request
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]outgoing-request
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]request-options
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]response-outparam
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]incoming-response
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]incoming-body
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]future-trailers
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]outgoing-response
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]outgoing-body
...
//go:wasmimport wasi:http/types@0.2.6 [resource-drop]future-incoming-response
...
//go:wasmimport wasi:http/types@0.2.6 http-error-code
func wasm_import_http_error_code(arg0 int32, arg1 uintptr)

func HttpErrorCode(err *wasi_io_0_2_6_error.Error) witTypes.Option[ErrorCode] {
...
//go:wasmimport wasi:http/types@0.2.6 [constructor]fields
...
//go:wasmimport wasi:http/types@0.2.6 [static]fields.from-list
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.get
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.has
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.set
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.delete
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.append
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.entries
...
//go:wasmimport wasi:http/types@0.2.6 [method]fields.clone
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.method
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.path-with-query
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.scheme
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.authority
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.headers
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-request.consume
...
//go:wasmimport wasi:http/types@0.2.6 [constructor]outgoing-request
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.body
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.method
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.set-method
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.path-with-query
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.set-path-with-query
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.scheme
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.set-scheme
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.authority
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.set-authority
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-request.headers
...
//go:wasmimport wasi:http/types@0.2.6 [constructor]request-options
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.connect-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.set-connect-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.first-byte-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.set-first-byte-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.between-bytes-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [method]request-options.set-between-bytes-timeout
...
//go:wasmimport wasi:http/types@0.2.6 [static]response-outparam.set
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-response.status
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-response.headers
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-response.consume
...
//go:wasmimport wasi:http/types@0.2.6 [method]incoming-body.stream
func wasm_import_method_incoming_body_stream(arg0 int32, arg1 uintptr)

func (self *IncomingBody) Stream() witTypes.Result[*wasi_io_0_2_6_streams.InputStream, witTypes.Unit] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_method_incoming_body_stream((self).Handle(), returnArea)
	var result witTypes.Result[*wasi_io_0_2_6_streams.InputStream, witTypes.Unit]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_io_0_2_6_streams.InputStream, witTypes.Unit](wasi_io_0_2_6_streams.InputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = witTypes.Err[*wasi_io_0_2_6_streams.InputStream, witTypes.Unit](witTypes.Unit{})
	default:
		panic("unreachable")
	}
	result0 := result
...
//go:wasmimport wasi:http/types@0.2.6 [static]incoming-body.finish
...
//go:wasmimport wasi:http/types@0.2.6 [method]future-trailers.subscribe
func wasm_import_method_future_trailers_subscribe(arg0 int32) int32

func (self *FutureTrailers) Subscribe() *wasi_io_0_2_6_poll.Pollable {
...
//go:wasmimport wasi:http/types@0.2.6 [method]future-trailers.get
...
//go:wasmimport wasi:http/types@0.2.6 [constructor]outgoing-response
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-response.status-code
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-response.set-status-code
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-response.headers
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-response.body
...
//go:wasmimport wasi:http/types@0.2.6 [method]outgoing-body.write
func wasm_import_method_outgoing_body_write(arg0 int32, arg1 uintptr)

func (self *OutgoingBody) Write() witTypes.Result[*wasi_io_0_2_6_streams.OutputStream, witTypes.Unit] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_method_outgoing_body_write((self).Handle(), returnArea)
	var result witTypes.Result[*wasi_io_0_2_6_streams.OutputStream, witTypes.Unit]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_io_0_2_6_streams.OutputStream, witTypes.Unit](wasi_io_0_2_6_streams.OutputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = witTypes.Err[*wasi_io_0_2_6_streams.OutputStream, witTypes.Unit](witTypes.Unit{})
	default:
		panic("unreachable")
	}
	result0 := result
...
//go:wasmimport wasi:http/types@0.2.6 [static]outgoing-body.finish
...
//go:wasmimport wasi:http/types@0.2.6 [method]future-incoming-response.subscribe
func wasm_import_method_future_incoming_response_subscribe(arg0 int32) int32

func (self *FutureIncomingResponse) Subscribe() *wasi_io_0_2_6_poll.Pollable {
...
//go:wasmimport wasi:http/types@0.2.6 [method]future-incoming-response.get
