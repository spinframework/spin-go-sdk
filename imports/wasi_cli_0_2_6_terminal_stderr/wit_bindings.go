...
package wasi_cli_0_2_6_terminal_stderr

import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_cli_0_2_6_terminal_output"
...
type TerminalOutput = wasi_cli_0_2_6_terminal_output.TerminalOutput

//go:wasmimport wasi:cli/terminal-stderr@0.2.6 get-terminal-stderr
func wasm_import_get_terminal_stderr(arg0 uintptr)

func GetTerminalStderr() witTypes.Option[*wasi_cli_0_2_6_terminal_output.TerminalOutput] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_get_terminal_stderr(returnArea)
	var option witTypes.Option[*wasi_cli_0_2_6_terminal_output.TerminalOutput]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		option = witTypes.None[*wasi_cli_0_2_6_terminal_output.TerminalOutput]()
	case 1:

		option = witTypes.Some[*wasi_cli_0_2_6_terminal_output.TerminalOutput](wasi_cli_0_2_6_terminal_output.TerminalOutputFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	default:
		panic("unreachable")
	}
	result := option
