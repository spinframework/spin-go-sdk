...
package wasi_sockets_0_2_6_instance_network
...
func InstanceNetwork() *wasi_sockets_0_2_6_network.Network {

	result := wasm_import_instance_network()
	return wasi_sockets_0_2_6_network.NetworkFromOwnHandle(int32(uintptr(result)))
