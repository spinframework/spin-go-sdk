...
func Handle(request *wasi_http_0_2_0_types.OutgoingRequest, options witTypes.Option[*wasi_http_0_2_0_types.RequestOptions]) witTypes.Result[*wasi_http_0_2_0_types.FutureIncomingResponse, wasi_http_0_2_0_types.ErrorCode] {
	...
	var result witTypes.Result[*wasi_http_0_2_0_types.FutureIncomingResponse, wasi_http_0_2_0_types.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_http_0_2_0_types.FutureIncomingResponse, wasi_http_0_2_0_types.ErrorCode](wasi_http_0_2_0_types.FutureIncomingResponseFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8))))))
	case 1:
		...
		case 22:
			...
			case 1:
				...
				option11 = witTypes.Some[wasi_http_0_2_0_types.FieldSizePayload](wasi_http_0_2_0_types.FieldSizePayload{option9, option10})
			default:
				panic("unreachable")
			}
		...
		result = witTypes.Err[*wasi_http_0_2_0_types.FutureIncomingResponse, wasi_http_0_2_0_types.ErrorCode](variant)
	default:
		panic("unreachable")
	}
	result31 := result
