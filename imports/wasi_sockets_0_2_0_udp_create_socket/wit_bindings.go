...
import (
	...
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_sockets_0_2_0_udp"
...
func CreateUdpSocket(addressFamily wasi_sockets_0_2_0_network.IpAddressFamily) witTypes.Result[*wasi_sockets_0_2_0_udp.UdpSocket, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_create_udp_socket(int32(addressFamily), returnArea)
	var result witTypes.Result[*wasi_sockets_0_2_0_udp.UdpSocket, wasi_sockets_0_2_0_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_sockets_0_2_0_udp.UdpSocket, wasi_sockets_0_2_0_network.ErrorCode](wasi_sockets_0_2_0_udp.UdpSocketFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = witTypes.Err[*wasi_sockets_0_2_0_udp.UdpSocket, wasi_sockets_0_2_0_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
