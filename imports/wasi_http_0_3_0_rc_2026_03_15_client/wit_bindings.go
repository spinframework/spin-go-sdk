...
package wasi_http_0_3_0_rc_2026_03_15_client
...
type Request = wasi_http_0_3_0_rc_2026_03_15_types.Request
type Response = wasi_http_0_3_0_rc_2026_03_15_types.Response
type ErrorCode = wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode

//go:wasmimport wasi:http/client@0.3.0-rc-2026-03-15 [async-lower]send
func wasm_import_send(arg0 int32, arg1 uintptr) int32

func Send(request *wasi_http_0_3_0_rc_2026_03_15_types.Request) witTypes.Result[*wasi_http_0_3_0_rc_2026_03_15_types.Response, wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode] {
	...
	var result witTypes.Result[*wasi_http_0_3_0_rc_2026_03_15_types.Response, wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[*wasi_http_0_3_0_rc_2026_03_15_types.Response, wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode](wasi_http_0_3_0_rc_2026_03_15_types.ResponseFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8))))))
	case 1:
		var variant wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8))) {
		case 0:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDnsTimeout()
		...
		case 1:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDnsError(wasi_http_0_3_0_rc_2026_03_15_types.DnsErrorPayload{option, option0})

		case 2:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDestinationNotFound()

		case 3:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDestinationUnavailable()

		case 4:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDestinationIpProhibited()

		case 5:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeDestinationIpUnroutable()

		case 6:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionRefused()

		case 7:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionTerminated()

		case 8:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionTimeout()

		case 9:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionReadTimeout()

		case 10:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionWriteTimeout()

		case 11:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConnectionLimitReached()

		case 12:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeTlsProtocolError()

		case 13:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeTlsCertificateError()
		...
		case 14:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeTlsAlertReceived(wasi_http_0_3_0_rc_2026_03_15_types.TlsAlertReceivedPayload{option1, option3})

		case 15:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestDenied()

		case 16:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestLengthRequired()
		...
		case 17:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestBodySize(option4)

		case 18:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestMethodInvalid()

		case 19:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestUriInvalid()

		case 20:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestUriTooLong()
		...
		case 21:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestHeaderSectionSize(option5)

		case 22:
			var option9 witTypes.Option[wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload]
			switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 16))) {
			case 0:

				option9 = witTypes.None[wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload]()
			case 1:
				...
				option9 = witTypes.Some[wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload](wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload{option7, option8})
			default:
				panic("unreachable")
			}

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestHeaderSize(option9)
		...
		case 23:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestTrailerSectionSize(option10)
		...
		case 24:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpRequestTrailerSize(wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload{option12, option13})

		case 25:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseIncomplete()
		...
		case 26:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseHeaderSectionSize(option14)
		...
		case 27:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseHeaderSize(wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload{option16, option17})
		...
		case 28:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseBodySize(option18)
		...
		case 29:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseTrailerSectionSize(option19)
		...
		case 30:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseTrailerSize(wasi_http_0_3_0_rc_2026_03_15_types.FieldSizePayload{option21, option22})
		...
		case 31:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseTransferCoding(option24)
		...
		case 32:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseContentCoding(option26)

		case 33:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpResponseTimeout()

		case 34:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpUpgradeFailed()

		case 35:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeHttpProtocolError()

		case 36:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeLoopDetected()

		case 37:

			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeConfigurationError()
		...
		case 38:
			...
			variant = wasi_http_0_3_0_rc_2026_03_15_types.MakeErrorCodeInternalError(option28)

		default:
			panic("unreachable")
		}

		result = witTypes.Err[*wasi_http_0_3_0_rc_2026_03_15_types.Response, wasi_http_0_3_0_rc_2026_03_15_types.ErrorCode](variant)
	default:
		panic("unreachable")
	}
