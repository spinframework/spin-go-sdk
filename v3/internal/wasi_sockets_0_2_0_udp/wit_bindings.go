...
package wasi_sockets_0_2_0_udp
...
type IncomingDatagram struct {
	...
	RemoteAddress wasi_sockets_0_2_0_network.IpSocketAddress
}
...
type OutgoingDatagram struct {
	...
	RemoteAddress wit_types.Option[wasi_sockets_0_2_0_network.IpSocketAddress]
}
...
func IncomingDatagramStreamFromBorrowHandle(handleValue int32) *IncomingDatagramStream {
	return IncomingDatagramStreamFromOwnHandle(handleValue)
}
...
func OutgoingDatagramStreamFromBorrowHandle(handleValue int32) *OutgoingDatagramStream {
	return OutgoingDatagramStreamFromOwnHandle(handleValue)
}
...
func (self *UdpSocket) StartBind(network *wasi_sockets_0_2_0_network.Network, localAddress wasi_sockets_0_2_0_network.IpSocketAddress) wit_types.Result[wit_types.Unit, wasi_sockets_0_2_0_network.ErrorCode] {
...
func (self *UdpSocket) FinishBind() wit_types.Result[wit_types.Unit, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) Stream(remoteAddress wit_types.Option[wasi_sockets_0_2_0_network.IpSocketAddress]) wit_types.Result[wit_types.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result wit_types.Result[wit_types.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_0_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[wit_types.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_0_network.ErrorCode](wit_types.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream]{IncomingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))), OutgoingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))})
	case 1:

		result = wit_types.Err[wit_types.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_0_2_0_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result23 := result
...
func (self *UdpSocket) LocalAddress() wit_types.Result[wasi_sockets_0_2_0_network.IpSocketAddress, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) RemoteAddress() wit_types.Result[wasi_sockets_0_2_0_network.IpSocketAddress, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) AddressFamily() wasi_sockets_0_2_0_network.IpAddressFamily {
...
func (self *UdpSocket) UnicastHopLimit() wit_types.Result[uint8, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetUnicastHopLimit(value uint8) wit_types.Result[wit_types.Unit, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) ReceiveBufferSize() wit_types.Result[uint64, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetReceiveBufferSize(value uint64) wit_types.Result[wit_types.Unit, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SendBufferSize() wit_types.Result[uint64, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetSendBufferSize(value uint64) wit_types.Result[wit_types.Unit, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) Subscribe() *wasi_io_0_2_0_poll.Pollable {
...
func (self *IncomingDatagramStream) Receive(maxResults uint64) wit_types.Result[[]IncomingDatagram, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result0 wit_types.Result[[]IncomingDatagram, wasi_sockets_0_2_0_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		...
		for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (2 * 4)))); index++ {
			...
			case 0:
				...
				variant = wasi_sockets_0_2_0_network.MakeIpSocketAddressIpv4(wasi_sockets_0_2_0_network.Ipv4SocketAddress{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), wit_types.Tuple4[uint8, uint8, uint8, uint8]{uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (6 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (7 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (9 + 2*4)))))}})

			case 1:

				variant = wasi_sockets_0_2_0_network.MakeIpSocketAddressIpv6(wasi_sockets_0_2_0_network.Ipv6SocketAddress{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4)))), wit_types.Tuple8[uint16, uint16, uint16, uint16, uint16, uint16, uint16, uint16]{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (12 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (14 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (16 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (18 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (20 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (22 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (24 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (26 + 2*4)))))}, uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (28 + 2*4))))})
		...
		result0 = wit_types.Ok[[]IncomingDatagram, wasi_sockets_0_2_0_network.ErrorCode](result)
	case 1:

		result0 = wit_types.Err[[]IncomingDatagram, wasi_sockets_0_2_0_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result1 := result0
...
func (self *IncomingDatagramStream) Subscribe() *wasi_io_0_2_0_poll.Pollable {
...
func (self *OutgoingDatagramStream) CheckSend() wit_types.Result[uint64, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *OutgoingDatagramStream) Send(datagrams []OutgoingDatagram) wit_types.Result[uint64, wasi_sockets_0_2_0_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	result := wit_runtime.Allocate(pinner, uintptr(length*(32+3*4)), 4)
	...
	var result0 wit_types.Result[uint64, wasi_sockets_0_2_0_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result0 = wit_types.Ok[uint64, wasi_sockets_0_2_0_network.ErrorCode](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 8))))
	case 1:

		result0 = wit_types.Err[uint64, wasi_sockets_0_2_0_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))
	default:
		panic("unreachable")
	}
	result1 := result0
...
func (self *OutgoingDatagramStream) Subscribe() *wasi_io_0_2_0_poll.Pollable {
