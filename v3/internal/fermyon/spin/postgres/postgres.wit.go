...
// ParameterValue represents the type alias "fermyon:spin/postgres#parameter-value".
//
// See [rdbmstypes.ParameterValue] for more information.
type ParameterValue = rdbmstypes.ParameterValue

// RowSet represents the type alias "fermyon:spin/postgres#row-set".
//
...
//
//go:nosplit
func Query(address string, statement string, params cm.List[ParameterValue]) (result cm.Result[RowSetShape, RowSet, PgError]) {
...
//
//go:nosplit
func Execute(address string, statement string, params cm.List[ParameterValue]) (result cm.Result[PgErrorShape, uint64, PgError]) {
	address0, address1 := cm.LowerString(address)
	statement0, statement1 := cm.LowerString(statement)
	params0, params1 := cm.LowerList(params)
