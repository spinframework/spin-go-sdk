...
import (
	...
	"github.com/spinframework/spin-go-sdk/v3/internal/wasi_clocks_0_2_0_wall_clock"
...
type DescriptorStat struct {
	...
	DataAccessTimestamp wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
	// Last data modification timestamp.
	//
	// If the `option` is none, the platform doesn't maintain a
	// modification timestamp for this file.
	DataModificationTimestamp wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
	// Last file status-change timestamp.
	//
	// If the `option` is none, the platform doesn't maintain a
	// status-change timestamp for this file.
	StatusChangeTimestamp wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
}
...
func DescriptorFromBorrowHandle(handleValue int32) *Descriptor {
	return DescriptorFromOwnHandle(handleValue)
}
...
func DirectoryEntryStreamFromBorrowHandle(handleValue int32) *DirectoryEntryStream {
	return DirectoryEntryStreamFromOwnHandle(handleValue)
}
...
func (self *Descriptor) ReadViaStream(offset uint64) wit_types.Result[*wasi_io_0_2_0_streams.InputStream, ErrorCode] {
	...
	var result wit_types.Result[*wasi_io_0_2_0_streams.InputStream, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*wasi_io_0_2_0_streams.InputStream, ErrorCode](wasi_io_0_2_0_streams.InputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*wasi_io_0_2_0_streams.InputStream, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) WriteViaStream(offset uint64) wit_types.Result[*wasi_io_0_2_0_streams.OutputStream, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
	wasm_import_method_descriptor_write_via_stream((self).Handle(), int64(offset), returnArea)
	var result wit_types.Result[*wasi_io_0_2_0_streams.OutputStream, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*wasi_io_0_2_0_streams.OutputStream, ErrorCode](wasi_io_0_2_0_streams.OutputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*wasi_io_0_2_0_streams.OutputStream, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) AppendViaStream() wit_types.Result[*wasi_io_0_2_0_streams.OutputStream, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) Advise(offset uint64, length uint64, advice Advice) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) SyncData() wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) GetFlags() wit_types.Result[DescriptorFlags, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 2, 1))
	wasm_import_method_descriptor_get_flags((self).Handle(), returnArea)
	var result wit_types.Result[DescriptorFlags, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[DescriptorFlags, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 1)))))
	case 1:

		result = wit_types.Err[DescriptorFlags, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 1)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) GetType() wit_types.Result[DescriptorType, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 2, 1))
	wasm_import_method_descriptor_get_type((self).Handle(), returnArea)
	var result wit_types.Result[DescriptorType, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[DescriptorType, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 1)))))
	case 1:

		result = wit_types.Err[DescriptorType, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 1)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) SetSize(size uint64) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) SetTimes(dataAccessTimestamp NewTimestamp, dataModificationTimestamp NewTimestamp) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) Read(length uint64, offset uint64) wit_types.Result[wit_types.Tuple2[[]uint8, bool], ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result wit_types.Result[wit_types.Tuple2[[]uint8, bool], ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		...
		result = wit_types.Ok[wit_types.Tuple2[[]uint8, bool], ErrorCode](wit_types.Tuple2[[]uint8, bool]{value, (uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (3 * 4)))) != 0)})
	case 1:

		result = wit_types.Err[wit_types.Tuple2[[]uint8, bool], ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) Write(buffer []uint8, offset uint64) wit_types.Result[uint64, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) ReadDirectory() wit_types.Result[*DirectoryEntryStream, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
	wasm_import_method_descriptor_read_directory((self).Handle(), returnArea)
	var result wit_types.Result[*DirectoryEntryStream, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*DirectoryEntryStream, ErrorCode](DirectoryEntryStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*DirectoryEntryStream, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) Sync() wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) CreateDirectoryAt(path string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) Stat() wit_types.Result[DescriptorStat, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 104, 8))
	wasm_import_method_descriptor_stat((self).Handle(), returnArea)
	var result wit_types.Result[DescriptorStat, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		var option wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 32))) {
		case 0:

			option = wit_types.None[wasi_clocks_0_2_0_wall_clock.Datetime]()
		case 1:

			option = wit_types.Some[wasi_clocks_0_2_0_wall_clock.Datetime](wasi_clocks_0_2_0_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 40))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 48)))})
		default:
			panic("unreachable")
		}
		var option0 wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 56))) {
		case 0:

			option0 = wit_types.None[wasi_clocks_0_2_0_wall_clock.Datetime]()
		case 1:

			option0 = wit_types.Some[wasi_clocks_0_2_0_wall_clock.Datetime](wasi_clocks_0_2_0_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 64))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 72)))})
		default:
			panic("unreachable")
		}
		var option1 wit_types.Option[wasi_clocks_0_2_0_wall_clock.Datetime]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 80))) {
		case 0:

			option1 = wit_types.None[wasi_clocks_0_2_0_wall_clock.Datetime]()
		case 1:

			option1 = wit_types.Some[wasi_clocks_0_2_0_wall_clock.Datetime](wasi_clocks_0_2_0_wall_clock.Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 88))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 96)))})
		default:
			panic("unreachable")
		}

		result = wit_types.Ok[DescriptorStat, ErrorCode](DescriptorStat{uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))), uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 16))), uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 24))), option, option0, option1})
	case 1:

		result = wit_types.Err[DescriptorStat, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))
	default:
		panic("unreachable")
	}
	result2 := result
...
func (self *Descriptor) StatAt(pathFlags PathFlags, path string) wit_types.Result[DescriptorStat, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) SetTimesAt(pathFlags PathFlags, path string, dataAccessTimestamp NewTimestamp, dataModificationTimestamp NewTimestamp) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) LinkAt(oldPathFlags PathFlags, oldPath string, newDescriptor *Descriptor, newPath string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) OpenAt(pathFlags PathFlags, path string, openFlags OpenFlags, flags DescriptorFlags) wit_types.Result[*Descriptor, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result wit_types.Result[*Descriptor, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*Descriptor, ErrorCode](DescriptorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*Descriptor, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) ReadlinkAt(path string) wit_types.Result[string, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result wit_types.Result[string, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		...
		result = wit_types.Ok[string, ErrorCode](value)
	case 1:

		result = wit_types.Err[string, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) RemoveDirectoryAt(path string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) RenameAt(oldPath string, newDescriptor *Descriptor, newPath string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) SymlinkAt(oldPath string, newPath string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) UnlinkFileAt(path string) wit_types.Result[wit_types.Unit, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *Descriptor) MetadataHash() wit_types.Result[MetadataHashValue, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 24, 8))
	wasm_import_method_descriptor_metadata_hash((self).Handle(), returnArea)
	var result wit_types.Result[MetadataHashValue, ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[MetadataHashValue, ErrorCode](MetadataHashValue{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 8))), uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 16)))})
	case 1:

		result = wit_types.Err[MetadataHashValue, ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *Descriptor) MetadataHashAt(pathFlags PathFlags, path string) wit_types.Result[MetadataHashValue, ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *DirectoryEntryStream) ReadDirectoryEntry() wit_types.Result[wit_types.Option[DirectoryEntry], ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result wit_types.Result[wit_types.Option[DirectoryEntry], ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		var option wit_types.Option[DirectoryEntry]
		switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4))) {
		case 0:

			option = wit_types.None[DirectoryEntry]()
		case 1:
			...
			option = wit_types.Some[DirectoryEntry](DirectoryEntry{uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (2 * 4))))), value})
		default:
			panic("unreachable")
		}

		result = wit_types.Ok[wit_types.Option[DirectoryEntry], ErrorCode](option)
	case 1:

		result = wit_types.Err[wit_types.Option[DirectoryEntry], ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result0 := result
...
func FilesystemErrorCode(err *wasi_io_0_2_0_error.Error) wit_types.Option[ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 2, 1))
	wasm_import_filesystem_error_code((err).Handle(), returnArea)
	var option wit_types.Option[ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		option = wit_types.None[ErrorCode]()
	case 1:

		option = wit_types.Some[ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 1)))))
	default:
		panic("unreachable")
	}
	result := option
